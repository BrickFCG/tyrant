...
public class Hero {
	...
	public static Thing createHero(String name, String race, String profession) {	
		...
		// set up HPS and MPS
		h.set(RPG.ST_HPSMAX, h.getBaseStat(RPG.ST_TG)+Rand.d(6));
		h.set(RPG.ST_MPSMAX, h.getBaseStat(RPG.ST_WP)+Rand.d(6));
	...
	private static void applyBonusItems(Thing h) {
		...
		if (h.getFlag(Skill.WEAPONLORE)) {
			Thing t=Lib.createType("IsWeapon",Rand.d(2,6));
			h.addThingWithStacking(t);
		}
...
//			 a reanged weapon + ammo
			Thing t=Lib.createType("IsRangedWeapon",Rand.d(h.getStat(Skill.ARCHERY),6));
			Thing ms=RangedWeapon.createAmmo(t,Rand.d(h.getStat(Skill.ARCHERY),6));
			h.addThing(t);
			h.addThing(ms);
		}
	...
	private static void applyProfession(Thing h, String p) {
		...
		if (p.equals("fighter")) {
			...
			h.incStat(RPG.ST_SK, Rand.r(5));
			h.incStat(RPG.ST_ST, Rand.r(5));
			h.incStat(RPG.ST_AG, Rand.r(4));
			h.incStat(RPG.ST_TG, Rand.r(6));
			h.incStat(RPG.ST_IN, Rand.r(0));
			h.incStat(RPG.ST_WP, Rand.r(0));
			h.incStat(RPG.ST_CH, Rand.r(0));
			h.incStat(RPG.ST_CR, Rand.r(0));
			h.incStat(Skill.ATTACK, 1);
			h.incStat(Skill.DEFENCE, 1);
			h.incStat(Skill.UNARMED, Rand.d(2));
			h.incStat(Skill.WEAPONLORE, Rand.d(2));
			
		} else if (p.equals("wizard")) {
			h.set("Image",6);

			h.incStat(RPG.ST_SK, Rand.r(0));
			h.incStat(RPG.ST_ST, Rand.r(0));
			h.incStat(RPG.ST_AG, Rand.r(0));
			h.incStat(RPG.ST_TG, Rand.r(0)-1);
			h.incStat(RPG.ST_IN, Rand.r(7));
			h.incStat(RPG.ST_WP, Rand.r(5));
			h.incStat(RPG.ST_CH, Rand.r(2));
			h.incStat(RPG.ST_CR, Rand.r(4));
			h.incStat(Skill.IDENTIFY, Rand.r(2));
			h.incStat(Skill.LITERACY, Rand.d(3));
			h.incStat(Skill.TRUEMAGIC, Rand.d(2));
			h.incStat(Skill.CASTING, Rand.d(2));
			h.incStat(Skill.FOCUS,Rand.d(2));
			h.addThing(Spell.randomOffensiveSpell(Skill.TRUEMAGIC,3));
			
			h.incStat("Luck",-5);
			
			// book and scroll
			h.addThing(SpellBook.create(Skill.TRUEMAGIC,Rand.d(6)));
			...
			h.incStat(RPG.ST_ST, Rand.r(0));
			h.incStat(RPG.ST_AG, Rand.r(0));
			h.incStat(RPG.ST_TG, Rand.r(0));
			h.incStat(RPG.ST_IN, Rand.r(4));
			h.incStat(RPG.ST_WP, Rand.r(4));
			h.incStat(RPG.ST_CH, Rand.r(5));
			h.incStat(RPG.ST_CR, Rand.r(6));
			h.incStat(Skill.IDENTIFY, Rand.r(2));
			h.incStat(Skill.LITERACY, Rand.r(2));
			h.incStat(Skill.BLACKMAGIC, Rand.d(3));
			h.incStat(Skill.CASTING, Rand.d(2));
			h.incStat(Skill.HERBLORE, Rand.d(2));
			h.addThing(Spell.randomSpell(Skill.BLACKMAGIC,3));
			
			h.incStat("Luck",15);
			
			// herbs and monster parts
			for (int i=0; i<10; i++) h.addThingWithStacking(Lib.createType("IsHerb",Rand.d(10)));
			for (int i=0; i<6; i++) h.addThingWithStacking(Lib.createType("IsMonsterPart",Rand.d(10)));
			...
			h.incStat(RPG.ST_AG, Rand.r(0));
			h.incStat(RPG.ST_TG, Rand.r(0));
			h.incStat(RPG.ST_IN, Rand.r(5));
			h.incStat(RPG.ST_WP, Rand.r(4));
			h.incStat(RPG.ST_CH, Rand.r(4));
			h.incStat(RPG.ST_CR, Rand.r(6));
			h.incStat(Skill.LITERACY, 1);
			h.incStat(Skill.BLACKMAGIC, 1);
			h.incStat(Skill.CASTING, 1);
			h.incStat(Skill.HERBLORE, Rand.r(3));
			h.incStat(Skill.COOKING, Rand.r(3));
			...
			h.addThing(Lib.create("[IsScroll]"));
			h.addThing(SpellBook.create(Skill.BLACKMAGIC,Rand.d(8)));
			
		} else if (p.equals("war-mage")) {
			h.set("Image",6);

			h.incStat(RPG.ST_SK, Rand.r(2));
			h.incStat(RPG.ST_ST, Rand.r(2));
			h.incStat(RPG.ST_AG, Rand.r(2));
			h.incStat(RPG.ST_TG, Rand.r(2));
			h.incStat(RPG.ST_IN, Rand.r(2));
			h.incStat(RPG.ST_WP, Rand.r(4));
			h.incStat(RPG.ST_CH, Rand.r(2));
			h.incStat(RPG.ST_CR, Rand.r(4));
			h.incStat(Skill.LITERACY, 1);
			h.incStat(Skill.TRUEMAGIC, Rand.r(3));
			h.incStat(Skill.HEALING, Rand.d(2));
			h.incStat(Skill.CASTING, Rand.d(2));
			...
			h.incStat(RPG.ST_AG, Rand.r(0));
			h.incStat(RPG.ST_TG, Rand.r(0));
			h.incStat(RPG.ST_IN, Rand.r(6));
			h.incStat(RPG.ST_WP, Rand.r(5));
			h.incStat(RPG.ST_CH, Rand.r(4));
			h.incStat(RPG.ST_CR, Rand.r(8));
			h.incStat(Skill.ALCHEMY, Rand.r(3));
			h.incStat(Skill.HERBLORE, Rand.r(2));
			h.incStat(Skill.IDENTIFY, Rand.d(2));
			h.incStat(Skill.LITERACY, Rand.d(4) );
			h.incStat(Skill.RUNELORE, Rand.d(2));
			...
			{
				Thing n=Lib.createType("IsWeaponRunestone",Rand.d(17));
				Item.identify(n);
				h.addThing(n);
			}
			
			for (int i=Rand.d(6); i>0; i--) {
				Thing n=Lib.createType("IsRunestone",Rand.d(10));
				Item.identify(n);
				h.addThing(n);
			}
			
			for (int i=Rand.r(3); i>0; i--) {
				Thing n=Lib.createType("IsRuneRecipeScroll",Rand.d(10));
				Item.identify(n);
				h.addThing(n);
			}
			...
			h.incStat(RPG.ST_ST, Rand.r(0));
			h.incStat(RPG.ST_AG, Rand.r(0));
			h.incStat(RPG.ST_TG, Rand.r(3));
			h.incStat(RPG.ST_IN, Rand.r(4));
			h.incStat(RPG.ST_WP, Rand.r(8));
			h.incStat(RPG.ST_CH, Rand.r(5));
			h.incStat(RPG.ST_CR, Rand.r(0));

			h.incStat(Skill.PRAYER, Rand.d(2));
			h.incStat(Skill.LITERACY, Rand.d(2));
			h.incStat(Skill.HOLYMAGIC, Rand.d(2));
			h.incStat(Skill.HEALING, Rand.r(3));
			h.incStat(Skill.MEDITATION, Rand.r(2));
			h.incStat(Skill.FOCUS, Rand.r(2));
			h.incStat("Luck",5);
			...
			h.incStat(Skill.IDENTIFY, Rand.d(2));
			h.incStat(Skill.LITERACY, Rand.d(2));
			h.incStat(Skill.HEALING, Rand.d(3));
			h.incStat(Skill.HERBLORE, Rand.d(2));
			h.incStat(Skill.MEDITATION, Rand.r(2));
			h.incStat(Skill.FOCUS, Rand.r(2));
			h.incStat("Luck",15);
			...
			h.addThing(Lib.create("potion of healing"));
			h.addThing(Lib.createType("IsHerb",Rand.d(10)));
			h.addThing(Lib.createType("IsHerb",Rand.d(10)));
			h.addThing(Lib.createType("IsHerb",Rand.d(10)));
			h.addThing(Lib.createType("IsHerb",Rand.d(10)));
			h.addThing(Lib.createType("IsHerb",Rand.d(10)));
			...
			h.incStat(RPG.ST_SK, Rand.r(3));
			h.incStat(RPG.ST_ST, Rand.r(0));
			h.incStat(RPG.ST_AG, Rand.r(3));
			h.incStat(RPG.ST_TG, Rand.r(0));
			h.incStat(RPG.ST_IN, Rand.r(3));
			h.incStat(RPG.ST_WP, Rand.r(3));
			h.incStat(RPG.ST_CH, Rand.r(6));
			h.incStat(RPG.ST_CR, Rand.r(6));
			...
			h.incStat(RPG.ST_SK, Rand.r(4));
			h.incStat(RPG.ST_ST, Rand.r(4));
			h.incStat(RPG.ST_AG, Rand.r(0));
			h.incStat(RPG.ST_TG, Rand.r(4));
			h.incStat(RPG.ST_IN, Rand.r(4));
			h.incStat(RPG.ST_WP, Rand.r(4));
			h.incStat(RPG.ST_CH, Rand.r(0));
			h.incStat(RPG.ST_CR, Rand.r(0));
			...
			h.incStat(Skill.PRAYER, Rand.d(2));
			h.incStat(Skill.ATTACK, Rand.r(2));
			h.incStat(Skill.DEFENCE, Rand.r(2));
			h.incStat(Skill.BRAVERY, Rand.d(3));
			
			h.addThing(Weapon.createWeapon(Rand.d(4)));
			Thing n=Lib.createType("IsWand",Rand.d(4));
			Item.identify(n);
			h.addThing(n);
			...
			h.incStat(RPG.ST_SK, Rand.r(3));
			h.incStat(RPG.ST_ST, Rand.r(3));
			h.incStat(RPG.ST_AG, Rand.r(5));
			h.incStat(RPG.ST_TG, Rand.r(5));
			h.incStat(RPG.ST_IN, Rand.r(0));
			h.incStat(RPG.ST_WP, Rand.r(0));
			h.incStat(RPG.ST_CH, Rand.r(0));
			h.incStat(RPG.ST_CR, Rand.r(0));
			...
			h.incStat(Skill.ALERTNESS, Rand.r(3));
			h.incStat(Skill.SURVIVAL, Rand.d(2));
			h.incStat(Skill.PICKPOCKET, Rand.r(2));
			h.incStat(Skill.UNARMED, 1);
			h.incStat(Skill.TRACKING, Rand.r(2));
			...
			h.incStat(RPG.ST_SK, Rand.r(5));
			h.incStat(RPG.ST_ST, Rand.r(0));
			h.incStat(RPG.ST_AG, Rand.r(6));
			h.incStat(RPG.ST_TG, Rand.r(0));
			h.incStat(RPG.ST_IN, Rand.r(0));
			h.incStat(RPG.ST_WP, Rand.r(0));
			h.incStat(RPG.ST_CH, Rand.r(4));
			h.incStat(RPG.ST_CR, Rand.r(3));
			h.incStat(RPG.ST_ATTACKSPEED, 120);

			h.incStat(Skill.ALERTNESS, Rand.d(3));
			h.incStat(Skill.PICKPOCKET, Rand.r(3));
			h.incStat(Skill.PICKLOCK, Rand.r(3));
			h.incStat(Skill.DISARM, Rand.r(2));
			...
			h.incStat(Skill.ARCHERY, Rand.r(3));
			h.incStat(Skill.THROWING, Rand.r(3));
			h.incStat(Skill.SURVIVAL, Rand.d(1));
			h.incStat(Skill.SWIMMING, Rand.r(2));
			h.incStat(Skill.RIDING, Rand.r(2));
			h.incStat(Skill.TRACKING, Rand.d(3));
			...
			h.incStat(RPG.ST_TG, Rand.r(4));
			h.incStat(RPG.ST_IN, Rand.r(0));
			h.incStat(RPG.ST_WP, Rand.r(6));
			h.incStat(RPG.ST_CH, Rand.r(4));
			h.incStat(RPG.ST_CR, Rand.r(6));

			h.incStat(Skill.THROWING, Rand.r(3));
			h.incStat(Skill.SURVIVAL, Rand.r(3));
			h.incStat(Skill.SWIMMING, Rand.r(2));
			h.incStat(Skill.COOKING, Rand.r(3));
			h.incStat(Skill.HERBLORE, Rand.d(2));
	...
	private static void applyRace(Thing h, String r) {
		if (r.equals("human")) {
			...
			Coin.addMoney(h,10 * Rand.d(4, 10));
			...
			Coin.addMoney(h,10 * Rand.d(5, 10));
			...
			Coin.addMoney(h,10 * Rand.d(6, 10));
			...
			Item.identify(n);
			h.addThing(n);
			Coin.addMoney(h,100 * Rand.d(10, 10));
			...
			h.addThing(Lib.createType("IsWeapon",Rand.d(3)));
			h.addThing(Lib.create("[IsMeat]"));
			Coin.addMoney(h,Rand.d(4, 10));
			...
			h.addThing(Lib.createType("IsClub",Rand.d(6)));
			h.addThing(Lib.create("[IsMeat]"));
			h.addThing(Lib.create("[IsMeat]"));
	...
	public static void action(Thing h,int t) {
		...
		hunger = Maths.min(hungerThreshold * 3, hunger + (t * 6)
		...
		switch (hl) {
			...
			case 2:
				for (int i=RPG.po(t,10000); i>0; i--) {
					...
					if (!h.getFlag("IsImmortal")) h.set(stat,Maths.max(sv-1,1));
				}
				break;
			case 3:
				// dying of hunger
